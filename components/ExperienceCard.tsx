...
function ExperienceCard({ experience }: Props) {
  return (
    <article className="flex flex-col rounded-lg items-center justify-items-center space-y-7 flex-shrink-0 w-[400px] md:w-[435px] md:mt-12 snap-center bg-[#e9ecef] p-10 hover:opacity-80 opacity-50 cursor-pointer transition-opacity duration-200 overflow-hidden justify-center">
      <motion.img
        initial={{
          x: -100,
          opacity: 0,
